"""
Django settings for blockchainsctrace_46000 project.
...
ROOT_URLCONF = 'blockchainsctrace_46000.urls'
...
WSGI_APPLICATION = 'blockchainsctrace_46000.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "blockchainsctrace_46000 API",
    "DESCRIPTION": "API documentation for blockchainsctrace_46000 App",
    "VERSION": "v1",
}
